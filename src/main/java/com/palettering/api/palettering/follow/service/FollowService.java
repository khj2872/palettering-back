...
public class FollowService {
    ...
    public Follow createFollow(String uid, String targetUid) {
        ...
        User user = userRepository.findById(uid).orElseThrow(IllegalAccessError::new);
        User targetUser = userRepository.findById(targetUid).orElseThrow(IllegalAccessError::new);
        int status = 0;
